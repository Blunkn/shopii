...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./login_register/login_register.css">
    ...
    <div class="container">
        ...
        <div class="login_card">
            ...
            <form method="POST" action=".">
                ...
                <input id="submit_button" type="submit" value="Login" class="button" name="form_submit">
                
                <!-- THIS LEADS TO THE INSECURE VERSION OF BOTH -->
                <div class="forgor">
                    <span>Not Registered?<br> <a href="./login_register/register.php">Register Here</a></span>
                    <span><a href="./login_register/reset.php">Forgot Password?</a></span>
                </div>
            </form>

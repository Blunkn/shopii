        ...
        <div class="container">
            <div class="login_card">
                ...
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <input id="submit_button" type="submit" value="Submit" class="button" name="form_submit">
                    <div class="forgor">
                        <span>Remember your password? <a href="./login_register/login.php">Login Here</a></span>
                    </div>
                </form>
